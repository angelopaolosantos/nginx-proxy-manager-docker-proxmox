...
resource "proxmox_virtual_environment_container" "nginx_proxy_manager_container" {
...
resource "proxmox_virtual_environment_download_file" "nginx_proxy_manager_ubuntu_24_04_standard_img" {
  content_type = "vztmpl"
  datastore_id = "local"
  node_name    = "pve01"
  file_name = "nginx-proxy-manager-ubuntu-24.04-standard.tar.zst"
